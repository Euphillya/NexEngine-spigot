...
public record UniParticle(Particle particle, Object data) {
    ...
    public static UniParticle itemCrack(@NotNull ItemStack item) {
        return new UniParticle(getParticle(Particle.ITEM, "ITEM_CRACK"), new ItemStack(item));
    }

    @NotNull
    public static UniParticle itemCrack(@NotNull Material material) {
        return new UniParticle(getParticle(Particle.ITEM, "ITEM_CRACK"), new ItemStack(material));
    }

    @NotNull
    public static UniParticle blockCrack(@NotNull Material material) {
        return new UniParticle(getParticle(Particle.BLOCK, "BLOCK_CRACK"), material.createBlockData());
    }

    @NotNull
    public static UniParticle blockDust(@NotNull Material material) {
        return new UniParticle(getParticle(Particle.DUST, "REDSTONE"), material.createBlockData());
    }
    ...
    public static UniParticle redstone(@NotNull Color color, float size) {
        return new UniParticle(getParticle(Particle.DUST, "REDSTONE"), new Particle.DustOptions(color, size));
    }
    ...
    public static UniParticle read(@NotNull JYML cfg, @NotNull String path) {
        ...
        } else if (dataType != Void.class) return UniParticle.of(getParticle(Particle.DUST, "REDSTONE"));
    ...
    public void write(@NotNull JYML cfg, @NotNull String path) {
        cfg.set(path + ".Name", this.isEmpty() ? "null" : this.particle().name());
    ...
    public UniParticle parseData(@NotNull String from) {
        ...
        return UniParticle.of(this.particle(), data);
    }
    ...
    private static Particle getParticle(Particle defaultType, String legacy) {
        try {
